...
impl Ipv6Hdr {
    ...
    pub fn payload_len(&self) -> u16 {
        getter_be!(self, payload_len, u16)
    }

    /// Sets the payload length.
    #[inline]
    pub fn set_payload_len(&mut self, len: u16) {
        setter_be!(self, payload_len, len)
    }

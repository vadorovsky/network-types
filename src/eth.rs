...
impl TryFrom<u16> for EtherType {
    ...
    fn try_from(value: u16) -> Result<Self, Self::Error> {
        match value.to_be() {
            ...
            other => Err(EthernetError::InvalidEtherType(other)),
        }
    }
}
...
mod tests {
    ...
    fn test_ethhdr_ether_type_method_unknown() {
        ...
        assert_matches!(eth_hdr.ether_type(), Err(EthernetError::InvalidEtherType(val)) if val == unknown_type_val);
    }
    ...
    fn test_ethertype_try_from_u16_unknown() {
        ...
        assert_matches!(EtherType::try_from(unknown_val.to_be()), Err(EthernetError::InvalidEtherType(val)) if val == unknown_val);
    }

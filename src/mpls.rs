...
/// Example use implementation generated by Gemini 2.5
/// Conceptual eBPF code:
...
mod tests {
    ...
    fn test_mpls_combined_setters_and_getters() {
        ...
        // Drop the mutable borrow before comparing bytes according to compiler warning
        let _ = mpls_header;
        ...
        // Drop the mutable borrow again before final comparison according to compiler warning
        let _ = mpls_header;
